<footer class="page-footer">
	...
	<div class="footer-nav">
		<div class="container clearfix">
			...
			<div class="footer-nav__col footer-nav__col--contacts">
				...
				Head Office: Charusat University<br>
            	Changa, Anand.
			</address>
				<div class="phone">
					Telephone:
					<a class="phone__number" href="tel:9988776655">9988-776-655</a>
				</div>
				<div class="email">
					Email:
					<a href="mailto:24MSIT125@charusat.edu.in" class="email__addr">24MSIT125@charusat.edu.in</a>
				</div>
			</div>
	...
	<div class="page-footer__subline">
		<div class="container clearfix">
			...
			<div class="copyright">
				&copy; 2025 charusat university&trade;
			</div>
